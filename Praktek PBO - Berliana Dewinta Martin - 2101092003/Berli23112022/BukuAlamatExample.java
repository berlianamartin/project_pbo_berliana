...
public class BukuAlamatExample {
    ...
    public static void main(String[] args){
        ...
        BukuAlamatRecords bukuAlamat[] =  new BukuAlamatRecords[100]; 
        ...
        switch(menu){
            case 1 : 
                in.nextLine();
                    for (i=0;i<n;i++){
                    BukuAlamatRecords bukuAlamat1 = new BukuAlamatRecords();
                    System.out.println("\nData ke-"+(i+1));
            ...
            case 4 : in.nextLine();
                     BukuAlamatRecords bukuAlamat2 = new BukuAlamatRecords();
